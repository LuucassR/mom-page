      ...
      <div className="flex flex-col md:flex-row items-center justify-between p-8 md:p-12 gap-8">
        ...
        <div className="flex-1 text-center md:text-left z-10 space-y-6">
          ...
          <div className="flex justify-center md:justify-start">
            <a 
              href="https://wa.me/3424443534?text=Hola!%20Estuve%20viendo%20tu%20web%20y%20me%20gustar%C3%ADa%20recibir%20asesor%C3%ADa%20sobre%20qu%C3%A9%20seguro%20me%20conviene%20m%C3%A1s.%20%C2%BFPodemos%20hablar%3F" 
              target="_blank" 
              rel="noreferrer"
